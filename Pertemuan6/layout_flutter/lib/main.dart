...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      title: 'Flutter layout: Nama: Aamira Faheema Ghania, NIM: 244107060081',
      home: Scaffold(
        appBar: AppBar(
